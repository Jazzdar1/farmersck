...
import FarmManager from './pages/FarmManager'; // New Page Import
        ...
        <div className="p-6 flex flex-col min-h-full">
          ...
          <nav className="flex-1 space-y-6 pb-10">
            <NavGroup title="Main Hub | مین">
              ...
              <NavLink to="/farm-manager" icon={Wallet} label="Farm Manager | منیجر" active={location.pathname === '/farm-manager'} onClick={() => setIsOpen(false)} />
      ...
      <main className="flex-1 lg:ml-72 flex flex-col min-h-screen">
        ...
        <div className="flex-1 p-4 md:p-8">
          <Routes>
            ...
            <Route path="/farm-manager" element={<ProtectedRoute><FarmManager /></ProtectedRoute>} />
