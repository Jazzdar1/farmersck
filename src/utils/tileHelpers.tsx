...
// 1. Icon Mapping (String to Component)
...
// 3. Default Data for Main Dashboard
export const DEFAULT_MAIN_TILES: DashboardTile[] = [
  { 
    id: '1', label: "میرا پورٹل", sub: "MY PORTAL", link: "/my-portal", 
    icon: "User", gradient: "from-emerald-500 to-teal-700", shadow: "shadow-emerald-500/40", 
    isActive: true, isLocked: true 
  },
  { 
    id: '2', label: "ماہر سے رابطہ", sub: "AI EXPERT", link: "/expert", 
    icon: "MessageCircle", gradient: "from-violet-500 to-purple-700", shadow: "shadow-purple-500/40", 
    isActive: true 
  },
  { 
    id: '3', label: "موسم کا حال", sub: "WEATHER HUB", link: "/weather", 
    icon: "CloudSun", gradient: "from-sky-400 to-blue-600", shadow: "shadow-sky-500/40", 
    isActive: true 
  },
  { 
    id: '4', label: "منڈی ریٹ", sub: "MARKET RATES", link: "/mandi", 
    icon: "BarChart3", gradient: "from-amber-400 to-orange-600", shadow: "shadow-orange-500/40", 
    isActive: true 
  },
  { 
    id: '5', label: "اسکینر", sub: "AI SCANNER", link: "/fck-scanner", 
    icon: "ScanEye", gradient: "from-rose-500 to-red-700", shadow: "shadow-rose-500/40", 
    isActive: true 
  },
  { 
    id: '6', label: "اسپرے ڈائری", sub: "SPRAY LOG", link: "/spray-tracker", 
    icon: "Sprout", gradient: "from-lime-500 to-green-700", shadow: "shadow-lime-500/40", 
    isActive: true 
  },
  {
      id: '7', label: "ڈیلر لوکیٹر", sub: "FIND DEALERS", link: "/dealers",
      icon: "MapPinned", gradient: "from-cyan-500 to-blue-700", shadow: "shadow-cyan-500/40",
      isActive: true
  }
];

// 4. Default Data for Farmer Portal (Internal)
export const DEFAULT_FARMER_TILES: DashboardTile[] = [
  ...
  { id: 'f7', label: "معلومات", sub: "KNOWLEDGE", link: "/knowledge", icon: "BookOpen", gradient: "from-pink-500 to-rose-600", shadow: "shadow-pink-500/40", isActive: true }
];