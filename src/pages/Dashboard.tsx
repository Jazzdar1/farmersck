...
function ToolTile({ onClick, icon: Icon, label, sub, bg, isLocked }: any) {
  return (
    <div 
      onClick={onClick} 
      className={`${bg} p-5 rounded-[2.5rem] border border-white/10 flex flex-col items-center justify-center text-center cursor-pointer hover:scale-105 active:scale-95 transition-all group relative`}
    >
